class Scelta:
    def __init__(self, testo, scena_destinazione=None, effetto=None):
        self.testo = testo
...
def crea_mappa_scene():
    ...
    chiamata_colin.aggiungi_scelta(Scelta("Segui Colin", "tetto"))
    chiamata_colin.aggiungi_scelta(Scelta("Non seguirlo", "gioco_controlla", effetto="lucidita--"))
